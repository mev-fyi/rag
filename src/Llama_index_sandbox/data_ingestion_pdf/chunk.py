...
def get_chunk_overlap(text_splitter_chunk_overlap_percentage, text_splitter_chunk_size):
    return int(text_splitter_chunk_overlap_percentage/100 * text_splitter_chunk_size)


@timeit
def chunk_documents(documents, text_splitter_chunk_overlap_percentage, text_splitter_chunk_size, splitter_fn=None, chunk_overlap=None):
    ...
    if chunk_overlap is None:
        chunk_overlap = get_chunk_overlap(text_splitter_chunk_overlap_percentage, text_splitter_chunk_size)
